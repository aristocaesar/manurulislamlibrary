...
('41211740', 'Hana Wulan Agusta', 'AK', 0, 100, '2022-06-05 23:21:56', '2022-06-05 23:21:56'),
('E41211739', 'Indah Novitasari', 'TKJ', -1, 80, '2022-06-05 22:45:41', '2022-06-05 22:45:41');
...
(1, 10, 0, 0, 2, '2022-05-11 15:41:11');
...
('TR-1654444196609', '602-6232-57-1', '1655049006831', 'Dikembalikan', 'Tidak Bermasalah', '89000.0', '2022-06-05 22:50:06', '2022-06-05 22:50:06'),
('TR-1654444196609', '978-602-0823-06-5', '1654049006864', 'Dikembalikan', 'Tidak Bermasalah', '8000.0', '2022-06-05 22:50:06', '2022-06-05 22:50:06');
...
CREATE TABLE `ma_log` (
  ...
  `pengurus` varchar(16) CHARACTER SET utf8mb4 NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('PGS - 04070', '5345435', 'a', 'a', 'Aristo Caesar Pratama', 'ADMINISTRATOR', 'AKTIF', '2022-04-29 21:59:11', '2022-05-15 02:42:27'),
('PGS - 23125', '2342343434', 'h', 'h', 'Hana Wulan Agusta', 'STAF', 'AKTIF', '2022-05-16 13:46:53', '2022-05-28 01:00:44');
...
(1, 5000, 2, 0, '2022-06-04 04:00:04');
...
INSERT INTO `ma_transaksi` (`id_transaksi`, `nis_anggota`, `kode_pengurus`, `kode_pengurus_kembali`, `jenis_buku`, `status_transaksi`, `created_at`, `updated_at`) VALUES
('TR-1654444196609', 'E41211739', 'PGS - 04070', NULL, 'UMUM', 'DIPINJAM', '2022-06-05 22:50:06', '2022-06-05 22:50:06');
...
ALTER TABLE `ma_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_ma_log_ma_pengurus` (`pengurus`);
...
--
ALTER TABLE `ma_log`
  ADD CONSTRAINT `FK_ma_log_ma_pengurus` FOREIGN KEY (`pengurus`) REFERENCES `ma_pengurus` (`kode`) ON UPDATE CASCADE;
